...
- организация рабочего процесса в качестве тимлида (постановка задач и сроков, координация работы команды, отслеживание и регулировка прогресса, мотивация, организация обмена опытом и обучения, контроль качества выполнения поставленных задач);
- реализация стандартных функций из библиотеки string.h;
- применение стандартов C11 и POSIX.1-2017, а также следование стилю кодирования Google Style;
- разработка и внедрение unit-тестов с использованием библиотеки Check для обеспечения качества кода и достижения покрытия тестами более 80%;
- обратока ошибок;
...
- Оформи решение как статическую библиотеку с названием _s21_string.a_ (с заголовочным файлом s21_string.h);
